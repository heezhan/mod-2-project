...
roti = Restaurant.create({name: "Roti", address: "1311 F St NW, Washington, DC 20004", price: "$", category: "Mediterranean", phone_number: "2028717329", website_url: "roti.com", hours_of_operation: "9-5"})
potbelly = Restaurant.create({name: "Potbellys", address: "709 H St NW, Washington, DC 20001", price: "$", category: "Fast Food", phone_number: "2023757893", website_url: "potbelly.com", hours_of_operation: "7-7:30"})
...
reservation1 = Reservation.create(date: "10/25/19", time: "11", guests: 3, restaurant: roti, guest: david)
reservation2 = Reservation.create(date: "11/18/19", time: "1", guests: 5, restaurant: potbelly, guest: heejae)
